...
type EditableProgram={id:string;code:string;name:string;description:string|null;rules:string|null;submission_form_url:string|null;registration_id_entry_key:string|null;full_name_entry_key:string|null;global_status:string};
